...
[1:v]fps=24,scale=1280:720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2,crop=640:720:540:0,chromakey=0x00FF00:0.20:0.08,despill=green,format=yuva420p,tpad=stop_mode=clone:stop_duration=${PAD_EVE}[ev];\
